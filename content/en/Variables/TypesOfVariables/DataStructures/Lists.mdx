...
<Callout type="warning" title="About len()">
The len() function is not a list method, it is a built-in function. Meaning you don't use the dot notation to call it. You call it like this: `len(list_name)`.
</Callout>
