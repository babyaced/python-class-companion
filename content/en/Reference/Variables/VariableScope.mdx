...
A <GlossaryTerm>variable</GlossaryTerm> defined in the global scope is accessible from anywhere in the code, including inside <GlossaryTerm term="function">functions</GlossaryTerm>.
...
<PythonRunner code={`x = 10  # Global variable
