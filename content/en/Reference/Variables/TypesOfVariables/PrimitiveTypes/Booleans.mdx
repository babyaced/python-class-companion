...
Refer to the section on [Control Flow](../../../ControlFlow) later in this course to learn how to use boolean variables in your code to make decisions and control the *flow* of your program.
